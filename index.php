...
<body>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br>
        <br>
        <h1 class="header center teal-text text-lighten-1">BibliotePA</h1>
        <div class="row center">
          <h5 class="header col s12 light">Web destinada a la busqueda de Libros de todo PA</h5>
        </div>
        <div class="row center">
          <a href="Glosario.php" id="download-button" class="btn-large waves-effect waves-light Cyan darken-2">Glosario de Libros</a>
        </div>
        <br>
        <br>
    ...
    <div class="parallax">
      <img src="img/rea.jpg" alt="Imagen 1">
    </div>
  </div>
  ...
  <div class="parallax-container valign-wrapper">
    ...
    <div class="parallax">
      <img src="img/rea.jpg" alt="Unsplashed background img 2">
    </div>
  </div>
  ...
  <div class="parallax-container valign-wrapper">
    ...
    <div class="parallax">
      <img src="img/gr.jpg" alt="Unsplashed background img 3">
    </div>
  </div>
